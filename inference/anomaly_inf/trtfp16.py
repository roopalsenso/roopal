...
# ==========================
# ==========================
ENGINE_PATH = "/root/old-data/home/roopal/engines/anomaly/anomalyfp16.trt"
...
for class_dir in test_root.iterdir():
    ...
    if class_dir.is_dir():
        ...
        for image_path in class_dir.glob("*.png"):
            ...
            score = run_fp16_trt(str(image_path))
...
csv_path = os.path.join(RESULT_DIR, "trt_fp16_scores.csv")
...
print(f"\nSaved TRT FP16 results to {csv_path}")
